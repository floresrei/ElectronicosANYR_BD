...
namespace ElectronicosANYR_BD.AppMVC.Controllers
{
    public class ProductosController : Controller
    {
        ...
        public ProductosController(ElectronicosAnyrBdContext context)
        {
            _context = context;
        }
        ...
        {
            var electronicosAnyrBdContext = _context.Productos.Include(p => p.Categoria);
            return View(await electronicosAnyrBdContext.ToListAsync());
        }
