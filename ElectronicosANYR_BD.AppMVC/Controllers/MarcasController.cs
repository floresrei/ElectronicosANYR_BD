...
namespace ElectronicosANYR_BD.AppMVC.Controllers
{
    public class MarcasController : Controller
    {
        ...
        public MarcasController(ElectronicosAnyrBdContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MarcaId,Nombre,PaisOrigen,SitioWeb,FechaRegistro")] Marca marca)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MarcaId,Nombre,PaisOrigen,SitioWeb,FechaRegistro")] Marca marca)
        {
            if (id != marca.MarcaId)
            {
                return NotFound();
